...
public interface QuesstionMapper {
    ...
    Integer countSearch(@Param(value = "search")String search);
    @Select("select * from question where title like #{search} limit #{offset},#{size}")
    List<Question> listSearch(@Param(value = "search")String search,@Param(value = "offset")Integer offset,@Param(value = "size")Integer size);
