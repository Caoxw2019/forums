...
public interface CommentMapper {
    ...
    @Select("select * from COMMENT,QUESTION,USER where  USER.ID=#{id} and COMMENT.PARENT_ID=QUESTION.ID and USER.ID=QUESTION.CREATOR order by COMMENT.GMT_CREATE DESC;")
